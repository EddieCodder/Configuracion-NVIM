...
// package.json
var djlintVersion = "1.19.12";
var djhtmlVersion = "1.5.2";
...
function resolveDjhtmlPath(context, toolPath) {
  if (!toolPath) {
    ...
    } else if (import_fs3.default.existsSync(import_path3.default.join(context.storagePath, "htmldjango", "venv", "Scripts", "djhtml.exe")) || import_fs3.default.existsSync(import_path3.default.join(context.storagePath, "htmldjango", "venv", "bin", "djhtml"))) {
      if (process.platform === "win32") {
        toolPath = import_path3.default.join(context.storagePath, "htmldjango", "venv", "Scripts", "djhtml.exe");
      } else {
        toolPath = import_path3.default.join(context.storagePath, "htmldjango", "venv", "bin", "djhtml");
      }
    } else {
      toolPath = "";
    }
...
function resolveDjlintPath(context, toolPath) {
  if (!toolPath) {
    ...
    } else if (import_fs3.default.existsSync(import_path3.default.join(context.storagePath, "htmldjango", "venv", "Scripts", "djlint.exe")) || import_fs3.default.existsSync(import_path3.default.join(context.storagePath, "htmldjango", "venv", "bin", "djlint"))) {
      if (process.platform === "win32") {
        toolPath = import_path3.default.join(context.storagePath, "htmldjango", "venv", "Scripts", "djlint.exe");
      } else {
        toolPath = import_path3.default.join(context.storagePath, "htmldjango", "venv", "bin", "djlint");
      }
    } else {
      toolPath = "";
    }
...
function getPythonPath(config, isRealpath) {
  ...
  try {
    ...
    if (isRealpath) {
      pythonPath = import_fs3.default.realpathSync(pythonPath);
    }
    return pythonPath;
  } catch (e) {
  }
...
async function doDjlintFormat(context, outputChannel, document, range) {
  ...
  import_fs4.default.writeFileSync(tmpFile.name, text);
...
`);
  ...
  return new Promise(function(resolve) {
    import_child_process3.default.execFile(djlintPath, [...args, tmpFile.name], opts, function(error, stdout, stderr) {
      let updateText;
      const originalText = import_fs4.default.readFileSync(tmpFile.name, "utf-8");
      if (error) {
...
`);
        if (isSuccess) {
          updateText = import_fs4.default.readFileSync(tmpFile.name, "utf-8");
        } else {
  ...
  async getHover(text, hoverLang) {
    ...
    for (const h in defineHovers) {
      if (text === defineHovers[h].prefix || defineHovers[h].alias.includes(text)) {
        const markdownPath = import_path4.default.join(
        ...
        try {
          result = import_fs5.default.readFileSync(markdownPath, { encoding: "utf8" });
        } catch (e) {
          return result;
        }
        break;
...
async function installTools(pythonCommand, context) {
  const pathVenv = import_path5.default.join(context.storagePath, "htmldjango", "venv");
  let pathVenvPython = import_path5.default.join(context.storagePath, "htmldjango", "venv", "bin", "python");
  if (process.platform === "win32") {
    pathVenvPython = import_path5.default.join(context.storagePath, "htmldjango", "venv", "Scripts", "python");
  }
